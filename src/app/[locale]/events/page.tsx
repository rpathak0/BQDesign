...
export default function EventsPage() {
  ...
  const featuredEvents = filtered.slice(0, 8);
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 w-full pt-20 md:pt-24">
        <div className="container mx-auto px-4 sm:px-5 md:px-6 pb-8">
          <motion.header
        ...
        {!loading && filtered.length === 0 && (
          <div className="container mx-auto px-4 sm:px-5 md:px-6 py-12">
