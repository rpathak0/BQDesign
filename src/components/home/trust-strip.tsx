  ...
  return (
    <section className="border-t border-white/5 bg-black/40">
      <div className="container mx-auto px-4 py-8 md:py-10 space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-4 text-sm">
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground" data-testid="text-secure-checkout">
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground" data-testid="text-instant-confirmation">
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                <p className="font-semibold">Official ticket seller</p>
                <p className="text-xs text-muted-foreground" data-testid="text-official-ticket-seller">
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground" data-testid="text-customer-support">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 text-sm">
          
          {/* Trust/Support Cluster */}
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 w-full lg:w-auto">
             {/* Hotline */}
             <div className="flex gap-4 items-start">
                <div className="rounded-full bg-white/5 p-3 shrink-0">
                  <PhoneCall className="w-5 h-5 text-[#7C3AED]" />
                </div>
                <div>
                  <p className="font-semibold text-base mb-1">Ticket hotline</p>
                  <p className="text-lg font-bold text-white mb-1" data-testid="text-hotline-number">
                    +974 4428 0999
                  </p>
                  <p className="text-xs text-muted-foreground" data-testid="text-hotline-hours">
                    Sun – Thu 09:00 – 17:00
                  </p>
                </div>
             </div>
             ...
             <div className="flex gap-4 items-start">
                <div>
                  <p className="font-semibold text-base mb-1">Chat with us</p>
             ...
             <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="font-semibold text-base mb-2">We accept</p>
                  <div
